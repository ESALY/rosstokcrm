...
class ProductAdmin extends Simpla
{
	public function fetch()
	{
		...
		if($this->request->method('post') && !empty($_POST))
		{
			...
			//поставщики товара
			$product->supplier1 = $this->request->post('supplier1');
			$product->price1 = $this->request->post('price1');
			$product->aprice1 = $this->request->post('aprice1');
			$product->astock1 = $this->request->post('astock1');
			$product->oprice1 = $this->request->post('oprice1');
			$product->ostock1 = $this->request->post('ostock1');
			$product->prod1 = $this->request->post('prod1');
			$product->art1 = $this->request->post('art1');
			$product->contacts1 = $this->request->post('contacts1');
			            $product->supplier2 = $this->request->post('supplier2');
            $product->price2 = $this->request->post('price2');
			$product->aprice2 = $this->request->post('aprice2');
			$product->astock2 = $this->request->post('astock2');
			$product->oprice2 = $this->request->post('oprice2');
			$product->ostock2 = $this->request->post('ostock2');
			$product->prod2 = $this->request->post('prod2');
			$product->art2 = $this->request->post('art2');
			$product->contacts2 = $this->request->post('contacts2');
			            $product->supplier3 = $this->request->post('supplier3');
            $product->price3 = $this->request->post('price3');
			$product->aprice3 = $this->request->post('aprice3');
			$product->astock3 = $this->request->post('astock3');
			$product->oprice3 = $this->request->post('oprice3');
			$product->ostock3 = $this->request->post('ostock3');
			$product->prod3 = $this->request->post('prod3');
			$product->art3 = $this->request->post('art3');
			$product->contacts3 = $this->request->post('contacts3');
			            $product->supplier4 = $this->request->post('supplier4');
            $product->price4 = $this->request->post('price4');
			$product->aprice4 = $this->request->post('aprice4');
			$product->astock4 = $this->request->post('astock4');
			$product->oprice4 = $this->request->post('oprice4');
			$product->ostock4 = $this->request->post('ostock4');
			$product->prod4 = $this->request->post('prod4');
			$product->art4 = $this->request->post('art4');
			$product->contacts4 = $this->request->post('contacts4');
			            $product->supplier5 = $this->request->post('supplier5');
            $product->price5 = $this->request->post('price5');
			$product->aprice5 = $this->request->post('aprice5');
			$product->astock5 = $this->request->post('astock5');
			$product->oprice5 = $this->request->post('oprice5');
			$product->ostock5 = $this->request->post('ostock5');
			$product->prod5 = $this->request->post('prod5');
			$product->art5 = $this->request->post('art5');
			$product->contacts5 = $this->request->post('contacts5');
			            $product->supplier6 = $this->request->post('supplier6');
            $product->price6 = $this->request->post('price6');
			$product->aprice6 = $this->request->post('aprice6');
			$product->astock6 = $this->request->post('astock6');
			$product->oprice6 = $this->request->post('oprice6');
			$product->ostock6 = $this->request->post('ostock6');
			$product->prod6 = $this->request->post('prod6');
			$product->art6 = $this->request->post('art6');
			$product->contacts6 = $this->request->post('contacts6');
			            $product->supplier7 = $this->request->post('supplier7');
            $product->price7 = $this->request->post('price7');
			$product->aprice7 = $this->request->post('aprice7');
			$product->astock7 = $this->request->post('astock7');
			$product->oprice7 = $this->request->post('oprice7');
			$product->ostock7 = $this->request->post('ostock7');
			$product->prod7 = $this->request->post('prod7');
			$product->art7 = $this->request->post('art7');
			$product->contacts7 = $this->request->post('contacts7');
			            $product->supplier8 = $this->request->post('supplier8');
            $product->price8 = $this->request->post('price8');
			$product->aprice8 = $this->request->post('aprice8');
			$product->astock8 = $this->request->post('astock8');
			$product->oprice8 = $this->request->post('oprice8');
			$product->ostock8 = $this->request->post('ostock8');
			$product->prod8 = $this->request->post('prod8');
			$product->art8 = $this->request->post('art8');
			$product->contacts8 = $this->request->post('contacts8');
			            $product->supplier9 = $this->request->post('supplier9');
            $product->price9 = $this->request->post('price9');
			$product->aprice9 = $this->request->post('aprice9');
			$product->astock9 = $this->request->post('astock9');
			$product->oprice9 = $this->request->post('oprice9');
			$product->ostock9 = $this->request->post('ostock9');
			$product->prod9 = $this->request->post('prod9');
			$product->art9 = $this->request->post('art9');
			$product->contacts9 = $this->request->post('contacts9');
			            $product->supplier10 = $this->request->post('supplier10');
            $product->price10 = $this->request->post('price10');
			$product->aprice10 = $this->request->post('aprice10');
			$product->astock10 = $this->request->post('astock10');
			$product->oprice10 = $this->request->post('oprice10');
			$product->ostock10 = $this->request->post('ostock10');
			$product->prod10 = $this->request->post('prod10');
			$product->art10 = $this->request->post('art10');
			$product->contacts10 = $this->request->post('contacts10');
