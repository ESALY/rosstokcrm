<?php /* Smarty version Smarty-3.1.18, created on 2015-04-06 17:18:10
         compiled from "simpla/design/html/manager.tpl" */ ?>
<?php /*%%SmartyHeaderCode:148712651054070c6a81a0d6-87717036%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '148712651054070c6a81a0d6-87717036',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_54070c6a928988_82394885',
  'variables' => 
  array (
    'manager' => 0,
    'm' => 0,
...
<?php if ($_valid && !is_callable('content_54070c6a928988_82394885')) {function content_54070c6a928988_82394885($_smarty_tpl) {?>
	...
	<div id="column_left">
		...
		<div class="block">
			<ul>
				...
				<?php $_smarty_tpl->tpl_vars['perms'] = new Smarty_variable(array('feed'=>'Лента','docs'=>'Документы','iorders'=>'Внутренние заказы','supplys'=>'Поставщики','dashboard'=>'Рабочий стол','products'=>'Товары','categories'=>'Категории','brands'=>'Бренды','features'=>'Свойства товаров','orders'=>'Заказы','labels'=>'Метки заказов','users'=>'Покупатели','groups'=>'Группы покупателей','coupons'=>'Купоны','pages'=>'Страницы','blog'=>'Блог','comments'=>'Комментарии','feedbacks'=>'Обратная связь','import'=>'Импорт','export'=>'Экспорт','backup'=>'Бекап','stats'=>'Статистика','design'=>'Дизайн','settings'=>'Настройки','currency'=>'Валюты','delivery'=>'Способы доставки','payment'=>'Способы оплаты','managers'=>'Менеджеры','license'=>'Управление лицензией'), null, 0);?>
