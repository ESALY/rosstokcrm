<?php /* Smarty version Smarty-3.1.18, created on 2014-12-17 10:49:02
         compiled from "simpla/design/html/currency.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1962458699540d974b09fd67-23918135%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1962458699540d974b09fd67-23918135',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_540d974b19ba84_62209990',
  'variables' => 
  array (
    'manager' => 0,
    'corrency_cbrf' => 0,
...
<?php if ($_valid && !is_callable('content_540d974b19ba84_62209990')) {function content_540d974b19ba84_62209990($_smarty_tpl) {?><?php $_smarty_tpl->_capture_stack[0][] = array('tabs', null, null); ob_start(); ?>
	...
	<!--доработка меню-->
	<?php if (in_array('menus',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?><li><a href="index.php?module=MenuAdmin">Меню</a></li><?php }?>
...
'},
	...
	<?php  $_smarty_tpl->tpl_vars['corrency'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['corrency']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['corrency_cbrf']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['corrency']->key => $_smarty_tpl->tpl_vars['corrency']->value) {
$_smarty_tpl->tpl_vars['corrency']->_loop = true;
?>
	<?php echo $_smarty_tpl->tpl_vars['corrency']->value->key;?>

	<?php echo $_smarty_tpl->tpl_vars['corrency']->value->val;?>
