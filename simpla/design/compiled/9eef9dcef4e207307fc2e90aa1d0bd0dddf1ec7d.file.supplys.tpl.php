<?php /* Smarty version Smarty-3.1.18, created on 2015-05-11 14:58:10
         compiled from "simpla\design\html\supplys.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2225154b7afe68e55f5-99377309%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9eef9dcef4e207307fc2e90aa1d0bd0dddf1ec7d' => 
    array (
  ...
  'nocache_hash' => '2225154b7afe68e55f5-99377309',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_54b7afe7483da3_29015699',
  'variables' => 
  array (
    'status' => 0,
    'new_count' => 0,
...
<?php if ($_valid && !is_callable('content_54b7afe7483da3_29015699')) {function content_54b7afe7483da3_29015699($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\OpenServer\\domains\\rosstok.ru\\Smarty\\libs\\plugins\\modifier.date_format.php';
?>
...
"><?php echo $_smarty_tpl->tpl_vars['p_su']->value->supplier;?>
            ...
            <td>
            <span class="b-label success"><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['item']->value->date,"%d %m %Y",'',"rus");?>
</span>
            <span style="display:block;margin-top:5px;"><?php echo $_smarty_tpl->tpl_vars['item']->value->author;?>
</span></td>
            <td>
            <span style="display:block;">
            <a target="_blank" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'UserAdmin','status'=>null,'id'=>$_smarty_tpl->tpl_vars['item']->value->userid),$_smarty_tpl);?>
"><?php echo $_smarty_tpl->tpl_vars['item']->value->user;?>
</a>
            </span>
            <span style="display:block;background-color: rgba(223, 243, 222, 0.66);">
            утв. цена|%
            </span>
            </td>
