<?php /* Smarty version Smarty-3.1.18, created on 2014-11-13 18:45:53
         compiled from "simpla/design/html/orders.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1018097394540721e5c5cb26-74585439%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1018097394540721e5c5cb26-74585439',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_540721e5ed2023_92489015',
  'variables' => 
  array (
    'manager' => 0,
    'status' => 0,
...
<?php if ($_valid && !is_callable('content_540721e5ed2023_92489015')) {function content_540721e5ed2023_92489015($_smarty_tpl) {?>
...
">Заказ №<?php echo $_smarty_tpl->tpl_vars['order']->value->id;?>
				...
				<div class="order_date cell">
				Покупатель:<br> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->name, ENT_QUOTES, 'UTF-8', true);?>

				</div>
				<div class="order_date cell">
	 				Заявка от:<br> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['date'][0][0]->date_modifier($_smarty_tpl->tpl_vars['order']->value->date);?>
 в <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['time'][0][0]->time_modifier($_smarty_tpl->tpl_vars['order']->value->date);?>
				...
				<div class="order_date cell">
	 				Дата отгрузки: <?php echo $_smarty_tpl->tpl_vars['order']->value->dataotgruzki;?>

				</div>
				<div class="order_date cell">
	 				Сумма:<br> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->total_price, ENT_QUOTES, 'UTF-8', true);?>
