<div id="divId">7777777</div>


<div class="user_price_wrapper">
 <h1>{$user->name|escape} {$user->rukovoditeltel|escape}</h1>
       <!--*****************************************************************************************************************************************************************-->
                            ...
                            {/function}
                             ...
                             <a  class="button button-flat button-tiny {if $smarty.cookies.view == 'vse'}button button-flat button-primary{/if}" onclick="document.cookie='view=vse;path=/';document.location.reload();" href="{url module=UserAdmin id=$user->id page=null}"><i class="fa fa-user"></i><i class="fa fa-filter"></i> Без фильтра</a>

                             <a  class="button button-flat button-tiny {if $smarty.cookies.view == 'beret'}button button-flat button-primary{/if}" onclick="document.cookie='view=beret;path=/';document.location.reload();" href="{url module=UserAdmin id=$user->id page=all}"><i class="fa fa-user"></i><i class="fa fa-filter"></i> Берет</a>

                             <a  class="button button-flat button-tiny {if $smarty.cookies.view == 'ispol'}button button-flat button-primary{/if}" onclick="document.cookie='view=ispol;path=/';document.location.reload();" href="{url module=UserAdmin id=$user->id page=all}"><i class="fa fa-user"></i><i class="fa fa-filter"></i> Интересуется</a>

                             <a  class="button button-flat button-tiny {if $smarty.cookies.view == 'spros'}button button-flat button-primary{/if}" onclick="document.cookie='view=spros;path=/';document.location.reload();" href="{url module=UserAdmin id=$user->id page=all}"><i class="fa fa-user"></i><i class="fa fa-filter"></i> Спрос (нет товара)</a>

                             <a  class="button button-flat button-tiny {if $smarty.cookies.view == 'nein'}button button-flat button-primary{/if}" onclick="document.cookie='view=nein;path=/';document.location.reload();" href="{url module=UserAdmin id=$user->id page=all}"><i class="fa fa-user"></i><i class="fa fa-filter"></i> Не интересно</a>
...
background: rgb(233, 246, 232);
width: 100%;
padding: 10px;
font-size: 18px;
font-weight: bold;
box-sizing: border-box;
border-radius: 10px 10px 0px 0px;">{$c->name}</span>
...
">Товар</span>
{/foreach}
                        <div class="userprice" style="display:block;">
                            ...
                            <table width="auto">
                                <thead>
                                    <tr class="nowrap">
                                        <th></th>
                                        <th>Товар</th>
                                        <th class="hiden"><input type="checkbox"> код товара</th>
                                        <th>Статусы</th>
                                        <th>Остаток</th>
                                        <th>Закупка</th>
                                        <th>Цена клиента</th>
                                        <th>Цена утв.</th>
                                        <th class="hiden"><input type="checkbox"> спец (цена/кол-во)</th>
                                        <th class="hiden"><input type="checkbox"> акция (цена/кол-во)</th>
                                        <th class="hiden"><input type="checkbox"> комментарий </th>
                                        <th></th>
                                        <th></th>
                                    </tr>
                                </thead>
...
{foreach $v->categories as $item1}
{$item1->name}
{/foreach}
{$v->category}
                                        </td>
                                        <!--товар-->
                                        <td class="hiden">{$v->sku}</td>
                                        <!--код товара-->
...
{else}
                                            ...
                                            {function name=utverzhdennaja_cena_tek} {foreach $product->utverzhdennaja_cena as $utverzhdennaja_c_per name=foo} {if $smarty.foreach.foo.first} {(($v->zakupka/100)*$utverzhdennaja_c_per->per)+$v->zakupka} {/if}{*if $smarty.foreach.foo.first*} {/foreach} {/function}

                                                <label>{utverzhdennaja_cena} р. | {utverzhdennaja_cena_per}%</label>
                                                <div id="cc{$product->id}" class="userp-table-prblock" onkeyup="summa_ot_procenta (this.id,{$v->zakupka})">
                                                    <input type="text" style="text-align:right;" class="userp-table-input" readonly id="utv{$product->id}" placeholder="{utverzhdennaja_cena_tek}">р. {*<i style="border-right:1px solid grey;"></i>*}
                                        ...
                                        <!--цена клиента-->
                                        <td  class="hiden" class="nowrap сbeige" onClick="HighLightTR(this,'#cfe2f3','cc3333');">{if $v->spec_cena == "0.00"} <span class="cell-placeholder">нет спец предложений</span>
...
margin-top: 10px;"><i class="pointer fa fa-paper-plane" onclick="send_spec_cena (this,{$product->id},{$user->id},'spec')"></i>
                                        ...
                                        <!--цена спец-->
                                        <td class="hiden" class="сgreen" onClick="HighLightTR(this,'#cfe2f3','cc3333');">{if $v->akcija_cena == "0.00"} <span class="cell-placeholder">нет акций</span>
...
margin-top: 10px;"><i class="pointer fa fa-paper-plane" onclick="send_akcija (this,{$product->id},{$user->id},'akcija')"></i>
                                        ...
                                        <td class="hiden">
                                            ...
                                            <li><button onclick="tobasket (this,{$product->id},'{$product->name}', 'z')">Запросить цену</button></li>
                                            <li><button onclick="tobasket (this,{$product->id},'{$product->name}', 'new')">Заказать</button></li>
                                            </ul>
                                        </td>
                                        <td>
                                        <button type="submit" id="121" class="pure-button pure-button user_show_history" onclick="showDialog('{url module=UserIframe productid=$product->id userid=$user->id}');"><i class="fa fa-pencil"></i></button>
                            ...
                            <table width="auto">
                                <thead>
                                    <tr class="nowrap">
                                        ...
                                        <th><input type="checkbox"> Цена клиента</th>
...
margin-top: 10px;"><i class="pointer fa fa-paper-plane" onclick="send_akcija (this,{$product->id},{$user->id},'akcija')"></i>
                                        ...
                                        <td>
                                            ...
                                            <li><div class="b-input"><input placeholder="кол-во"/></div></li>
                                            <li><a class="button button-flat button-flat button-tiny" href="#" onclick="tobasket (this,{$product->id},'{$product->name}')">заказать</a></li>
                                            </ul>
                                        </td>
                                    </tr>
                                    {/if}
...
<script>
    function tobasket(el, id, prodname, status) {
            ...
            var comment = "{/literal}{$m->login|escape}{literal}";
