...
<h1>Новая заявка</h1>
    ...
    <tbody id="iorders-order-tbody">
        <tr class="clonedInput">
            <td><select id="color" class="rus-forms-elastic-input" name="purchases[variant_id][{$item->id}]">
...
<div class="group">
        ...
        <input id="text" type="text" name="manager" value="{$manager->login|escape}">
        </div>
        <div class="group">
        ...
        <input id="text" type="text" name="date_created" value="{$smarty.now|date_format:"%d %m %Y (%H:%M)":"":"rus"}">
        </div>
        <div class="group">
        <label for="text">Дата отгрузки</label>
        <input id="text" type="text" name="date_out" value="{$smarty.now|date_format:"%d %m %Y (%H:%M)":"":"rus"}">
        </div>
