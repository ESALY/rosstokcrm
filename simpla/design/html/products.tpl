...
">Рабочий стол {$m->login|escape}</span>*}

<div class="wrap" style="width: 980px;margin: auto;    margin-top: 20px;">
<div class="wrap-inner" style="display:inline-block;">
{* Вкладки *}
{capture name=tabs}
...
<div id="main_list" class="wrapshadow">

<div class="modSearch" style="margin-bottom: 25px;">
    <form method="get">
    <input type="hidden" name="module" value="ProductsAdmin">
        <input id="search-box" class="search" type="text" name="keyword" value="" placeholder="Поиск по товарам">
