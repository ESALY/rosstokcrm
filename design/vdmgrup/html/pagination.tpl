...
<div class="pagination">
    ...
    ←<a class="left" href="{url page=null}">предыдущая</a>
	...
	{*if $current_page_num>2}←<a class="left" href="{url page=$current_page_num-1}">предыдущая555</a>{/if*}
    
	{if $current_page_num<$total_pages_num}<a class="right" href="{url page=$current_page_num+1}">следующая</a>→{/if}
