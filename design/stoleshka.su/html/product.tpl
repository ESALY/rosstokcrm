...
<h1 class="ie6_main_h1" data-product="{$product->id}">{$product->name|escape}<i></i></h1>
...
<div class="product">
	...
	{if $product->image}
	<div class="image">
		<a href="{$product->image->filename|resize:800:600:w}" class="zoom" data-rel="group"><img class="prod-img" src="{$product->image->filename|resize:300:300}" alt="{$product->product->name|escape}" /></a>
	</div>
	{/if}
...
<!-- Описание товара -->
	<div class="description">
         ...
         <h2>Выберите необходимый размер и тип покрытия</h2>
		...
		<form class="variants" action="/cart">
			...
			<input style="margin-top:10px;" type="submit" class="button" value="в корзину" data-result-text="добавлено"/>
		</form>
...
<h1 class="ie6_main_h1" style="clear: both" data-product="{$product->id}">Описание<i></i></h1>
