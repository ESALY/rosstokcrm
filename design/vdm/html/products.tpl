			...
			<tr class="variant">
				...
				<td>
					...
					{if $v->compare_price > 0}<span class="compare_price">{$v->compare_price|convert}</span>{/if}
                                 <span>Цена за 1шт:</span> <span class="price">{$v->price|convert} <span class="currency">{$currency->sign|escape}</span></span>
                         </div>
                                </td>
			</tr>
			{/foreach}
                        ...
                        <div id="fastorderbtn" class="button big blue b1c">Быстрый заказ</div>
...
<div id="prdribbons">
    ...
    <!-- Вывод свойств товара end -->    
 <!-- Вывод наличия товара -->
   <div id="prodribboninstock"></div>
  <!-- Вывод наличия товара end --> 
<!-- Вывод свойств товара -->
     <!--<div id="prodribbondiscgroup"><span>№1</span></div> --> 
   <!-- Вывод свойств товара end -->  
   </div>
